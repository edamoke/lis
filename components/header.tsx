                            ...
                            {leftMenuItems.map((item) =>
                                item.label === 'Schools' ? (
                                    <div key="schools" className="relative group">
                                        <button className="flex items-center gap-1 text-sm font-medium text-foreground/80 hover:text-foreground px-3 py-1.5 rounded-md hover:bg-foreground/5 transition-colors duration-150">
                                            Schools
                                            ...
                                            <div className="p-1.5">
                                                {campuses.map((campus) => (
                                                    <Link
                                                        key={campus.href}
                                                        href={campus.href}
                                                        className="flex flex-col px-3 py-2 rounded-lg hover:bg-foreground/5 transition-colors">
                                    ...
                                    <Link
                                        key={item.label}
                                        href={item.href}
                                        className="text-sm font-medium text-foreground/80 hover:text-foreground px-3 py-1.5 rounded-md hover:bg-foreground/5 transition-colors duration-150">
                                        {item.label}
                                    </Link>
                                )
                            )}
